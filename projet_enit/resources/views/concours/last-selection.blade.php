...
@section('content')
    ...
    <div class="container-fluid" style="margin-top : 50px">
        ...
        <br><br>
        <div class="load">
            <h3 class="m-0 font-weight-bold text-primary">Sélection finale</h3>
                ...
                <div class="table-responsive">
                    <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="d-flex justify-content-center">
                            <div class="row">
                                <div class="col">
                                    <select class="form-control poste" style="visibility: hidden">
                            ...
                            <div class="col">
                                @foreach($messages as $message)
                                    ...
                                    : {{$message->objet}}<br/>
                                @endforeach
                                <button class="btn btn-primary sendPrevmail">Publier les messages pour
                                    l'administrateur
                                </button>
                                    ...
                                    <div class="col-sm-12">
                                        <table class="table table-bordered dataTable" id="dataTable" width="100%"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting score_2 here" tabindex="0" aria-controls="dataTable"
                                                    rowspan="1"
                                                    colspan="1" aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending"
                                                ...
                                                {{--<th class="sorting" tabindex="0" aria-controls="dataTable"
                                                    ...
                                                    colspan="1" aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending"
                                                    style="width: 270px;">Conformité
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable"
                                                    rowspan="1"
                                                    colspan="1" aria-sort="ascending"
                                                    aria-label="Name: activate to sort column descending"
                                                    style="width: 270px;">Notes
                                                </th>--}}
                                            ...
                                            {{--  @isset($candidat['tmp'])
                                                  @foreach($candidat['tmp'] as $c)
                                                      <tr role="row" class="odd">
                                                          ...
                                                          <td>
                                                              {{ date('d-m-Y', strtotime($c->birthday)) }}</td>
                                                          <td>{{$c->user->email}}</td>
                                                          <td>{{$c->user->cin}}</td>
                                                          <td>{{$c->mobile_phone}}</td>
                                                          <td class="{{$poste->id}}">{{$c->score_1}}</td>
                                                          <td>
                                                              <a href="{{route('showConformityAdd',$c->user->cin)}}"
                                                                 class="btn btn-primary btn-icon-split"> <span
                                                                      class="icon text-white-50"> <i
...
//  $(".23").hide();
          ...
          /*  $('.dataTable').DataTable({
            ...
            $(document).on('click', '.sendPrevmail', function () {
                ...
                if (confirm("Veuillez vraiment envoyer provisoirement les mails !")) {
                    var tabPage = [];
