        ...
        <div class="col-md-8">
            ...
            @if($res == 1)
                @if($current_date <= $date_prevesoire)
                    <p class="alert alert-info text-center"> votre dossier est en cours de traitement</p>
                @elseif($current_date <= $date_publicaltion)
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            <label for="full_name"
                                    ...
                                    *</b></label>
                            <div class="col-md-10" >
                                <select name="poste" id="my_select" class="form-control"style="margin-left: -14px;"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="dob" id="dob" class="form-control" placeholder="d/m/Y"
                                ...
                                <div class="form-group row" id="dip_elem">
                                    ...
                                    <div class="col-md-6">
                                        <select name="diploma" id="diploma" class="form-control"
                                                @if ($errors->first('diploma')) style="border-color: red" @endif>
                                            <option value="{{$candidat->diplome_id}}"
                                                    selected>@if (Config::get('app.locale') == 'fr'){{$candidat->diplome->titre}}@else{{$candidat->diplome->titre_AR}}@endif</option>
                                        </select>
                                        @if ($errors->first('diploma'))
                                            <span
                                                style="color: red"> {{ $errors->first('diploma') }}</span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline" style="float: left;">
                                        <input class="form-check-input" type="radio" id="inlineRadio6"
                                               name="bureau" <?php echo ($candidat->conformite_attestation_inscription == 'yes') ? 'checked="checked"' : '' ?>
                                        ...
                                        <input class="form-check-input" type="radio" id="inlineRadio7"
                                               name="bureau" <?php echo ($candidat->conformite_attestation_inscription == 'no') ? 'checked="checked"' : '' ?>
                                               @if ($errors->first('bureau')) style="border-color: red"
                                               @endif
                                               value="no">
                                        <label class="form-check-label"
                            ...
                            <div class="form-group row permis">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="date_of_obtaining_a_driving_license" class="form-control"
                                           ...
                                           value="{{date("d/m/Y", strtotime($candidat->date_of_obtaining_a_driving_license))}}"
                                           placeholder="Jours/Mois/Année"
