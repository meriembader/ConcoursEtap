...
class ExportFirstSelection implements FromCollection, WithMapping, WithColumnFormatting, WithHeadings, ShouldAutoSize, WithEvents
{
    private $post_id;
    private $limit;
    private $candidat;
    ...
    public function collection()
    {
        ...
        return Candidat::where('poste_id', $this->post_id->id)
